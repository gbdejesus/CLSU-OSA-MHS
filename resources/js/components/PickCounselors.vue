<template>
    <div>
        <div class="container">
            ...
            <div class="row" v-if="!loading">
                ...
                <div class="col-12 col-sm-6 col-lg-3" v-for="(counselor, index) in counselors" data-backdrop="static"
                     type="button" data-toggle="modal" data-target="#select-counselor" @click="confirmModal(index)">
        ...
        <!-- The Modal -->
        <div class="modal" id="select-counselor">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">

                    <!-- Modal Header -->
                    <div class="modal-header">
                        <h4 class="modal-title">Select Counselor</h4>
                    </div>

                    <!-- Modal body -->
                    <div class="modal-body">
                        <div class="alert alert-success" v-if="apiResponse.show && apiResponse.success">
                            <strong>Success!</strong> You have been successfully picked a COUNSELOR.
                        </div>
                        ...
                        Are you sure to select Mr./Ms. {{ selectedCounselor.name }} as your COUNSELOR?
                        </span>
                    </div>
                    ...
                    <div class="modal-footer">
                        <div v-if="!apiResponse.show && !apiResponse.success">
                            <button type="button" class="btn btn-success" @click="confirmCounselor">Yes</button>
...
export default {
    ...
    methods: {
        ...
        confirmModal: function (index) {
            this.selectedCounselor = this.counselors[index];
        },
        confirmCounselor: function () {
            this.apiResponse.show = false;
            axios.post('/api/counselor/select/' + this.selectedCounselor.id + '/' + this.userId, )
                .then(response => {
                    this.apiResponse.data = response.data.response;
